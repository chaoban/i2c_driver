...
#define __CHAOBAN_SIS810_I2C

#ifdef __CHAOBAN_SIS810_I2C
static struct twl4030_platform_data sis810_data = {
	.irq_base	= TWL4030_IRQ_BASE,
	.irq_end	= TWL4030_IRQ_END,
...
static struct i2c_board_info __initdata sis810_i2c_boardinfo[] = {
	{
		I2C_BOARD_INFO("synaptics-rmi-ts", 0x05),
	//	.flags = I2C_CLIENT_WAKE,
	//	.irq = INT_34XX_I2C3_IRQ,
	//	.platform_data = &sis810_data,
	},
};
#endif
...
#ifdef __CHAOBAN_SIS810_I2C
	omap_register_i2c_bus(2, 100, sis810_i2c_boardinfo, ARRAY_SIZE(sis810_i2c_boardinfo));		
#endif
